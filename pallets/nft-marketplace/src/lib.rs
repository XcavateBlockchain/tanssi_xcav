...
type BalanceOf<T> = <T as pallet_assets::Config<pallet_assets::Instance2>>::Balance;
...
pub mod pallet {
        ...
        + pallet_nft_fractionalization::Config
    {
        ...
        type Helper: crate::BenchmarkHelper<
            ...
            <Self as pallet_assets::Config<Instance2>>::AssetId,
            Self,
        >;
        ...
        type AssetId2: IsType<<Self as pallet_assets::Config<Instance2>>::AssetId>
            + Parameter
            + From<u32>
            + Ord
            + Copy;
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn create_new_location(
            ...
            T::LocationOrigin::ensure_origin(origin)?;
                ...
                Self::region_collections(region).is_some(),
        ...
        pub fn list_object(
            ...
            while pallet_assets::Pallet::<T, Instance2>::maybe_total_supply(asset_id.into())
                .is_some()
            {
            ...
            let fractionalize_collection_id: FractionalizeCollectionId<T> = collection_id
                .try_into()
        ...
        pub fn relist_token(
            ...
            pallet_assets::Pallet::<T, Instance2>::transfer(
                origin,
                asset_id.into().into(),
                pallet_lookup,
                token_amount,
